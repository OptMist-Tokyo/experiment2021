...
import cv2
from color_your_music_mood import color_map_2d
...
"""
img = cv2.cvtColor(cv2.imread("color_your_music_mood/music_color_mood.png"),
                   cv2.COLOR_BGR2RGB)
...
def record_audio(block_size, devices, use_yeelight_bulbs=False, fs=8000):
    ...
    [classifier, mu, std, class_names,
     mt_win, mt_step, st_win, st_step, _] = aT.load_model("color_your_music_mood/model")

    [clf_energy, mu_energy, std_energy, class_names_energy,
     mt_win_en, mt_step_en, st_win_en, st_step_en, _] = \
        aT.load_model("color_your_music_mood/energy")
